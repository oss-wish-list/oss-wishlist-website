...
export default function AuthenticatedWishlists({ children }: AuthenticatedWishlistsProps) {
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Please sign in with GitHub to browse project wishlists and discover funding opportunities.
          </p>
          <button
            onClick={login}
          ...
          <p className="text-sm text-gray-500 mt-6">
            We use GitHub OAuth to verify your identity and ensure authentic community participation.
          </p>
        </div>
      </div>
    );
